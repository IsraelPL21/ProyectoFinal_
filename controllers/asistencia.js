...
const modelsAsistencia = require("../models/asistencia");
...
const MostrarPersonal = async (req = request, res = response) => {
    let conn;
...
const EditarPersonal = async (req = request, res = response) => {
    const {ID, nombre, apellido, activo} = req.body//URI params
...
const Asistencia = async (req = request, res = response) => {
    ...
    try {
        ...
        const [pers] = await conn.query(`SELECT ID FROM Personal WHERE nombre = ?`, [nombre], (error) =>{if(error) throw error})
...
const EditarAsistencia = async (req = request, res = response) => {
    const {ID, asistencia, aula, grupo, observacion, activo, nombre} = req.body//URI params
...
module.exports = {AgregarPersonal, MostrarPersonal, EditarPersonal, EliminarPersonal, Asistencia, EditarAsistencia}